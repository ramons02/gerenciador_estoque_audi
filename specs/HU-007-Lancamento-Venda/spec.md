# Spec - HU-007 — Lançamento Rápido de Venda (Balcão/Entrega)
...
Como vendedor, quero lançar uma venda rapidamente com produto, quantidade, tipo e forma de pagamento, para atender o cliente da portaria sem demora.
